...
class Strategy:
    ...
    def _positive_trade(self, pattern):
        ...
        print('{0} positive: {1}'.format(pattern["mid_product"].name, 100/from_product_ask*mid_product_bid*to_product_bid))
    ...
    def _negative_trade(self, pattern):
        ...
        print('{0} negative: {1}'.format(pattern["mid_product"].name, 100/to_product_ask/mid_product_ask*from_product_bid))
