...
def scheduler_trade(s):
    product_trade = [{"from_product": Product.QASHUSD, "mid_product": Product.QASHBTC, "to_product": Product.BTCUSD, "base_fund": 15}]
    ...
    product_trade.append({"from_product": Product.ETHJPY, "mid_product": Product.ETHBTC, "to_product": Product.BTCJPY, "base_fund": 1500})
